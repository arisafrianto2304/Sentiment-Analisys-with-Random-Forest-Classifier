...
clf = RandomForestClassifier(n_estimators=100, max_depth = 250, criterion = 'gini',  random_state=0)
#clf = RandomForestClassifier(n_estimators=100, max_depth=2, random_state=0)
#clf = svm.SVC(kernel='linear')

predictU = cross_val_predict(clf,tfidfU,label,cv=10)
...
predictB = cross_val_predict(clf,tfidfB,label,cv=10)
...
predictT = cross_val_predict(clf,tfidfT,label,cv=10)
...
for c in actualCompare:
    ...
    csvFile.close()
print('')
print("TN, FP, FN, TP : ",tnU,fpU,fnU,tpU)
print("Unigram acc:", accU)
print("Unigram Precision", precisionU)
print("Unigram Recall", recallU)
print("Unigram F-Measure",fMeasureU)
for c in predictUCompare:
    ...
    csvFile.close()
print('')
print("TN, FP, FN, TP : ",tnB,fpB,fnB,tpB)
print("Bigram acc:", accB)
print("Bigram Precision", precisionB)
print("Bigram Recall", recallB)
print("Bigram F-Measure",fMeasureB)
...
print("Tigram Precision", precisionT)
print("Tigram Recall", recallT)
print("Tigram F-Measure",fMeasureT)
